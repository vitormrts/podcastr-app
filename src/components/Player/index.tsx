...
export function Player() {
    ...
    const { episodeList, currentEpisodeIndex, isPlaying, togglePlay, setPlayingState, playNext, playPrevious, hasNext, hasPrevious, isLooping, toggleLoop, isShuffling, toggleShuffle, clearPlayerState } = usePlayer()
    ...
    function setupProgressListener() {
        audioRef.current.currentTime = 0 // o tempo atual vira 0 quando o som eh mudado
